...
BOT_TOKEN = environ.get('BOT_TOKEN', "5699367227:AAGzPCkbRhWXbPLe33jvwUgKwl6BHiGysGg")    # Bot token from @BotFather
...
PICS_URL = (environ.get('PICS', 'https://graph.org/file/9d92a05bd13c4fb04fc3d-a81852ea9bb334abe2.jpg')).split() #random anime girl img each time from aniwallpaper (Experimental)
PICS = (environ.get('PICS', 'https://graph.org/file/9d92a05bd13c4fb04fc3d-a81852ea9bb334abe2.jpg https://graph.org/file/d64f39522ecec57850efa-b10e4eaf84e3e19727.jpg https://graph.org/file/2a92b6cd93ec6636861af-14cc14128b996924e9.jpg https://graph.org/file/90ba75774e34cb38c2819-f29ee49cc305a3e5ec.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://graph.org/file/90ba75774e34cb38c2819-f29ee49cc305a3e5ec.jpg")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003895931534 -1001794709970 -1001843452433').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003405834119'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003700411154'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003405834119'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001870948551')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001836251992')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/movi_clubb')  # Support group link (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://wazeem:a4d86W9kJ3npHxaD@forwardcluster.lwso62u.mongodb.net/myDatabase?retryWrites=true&w=majority")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'wazeem_files') # Collection name (default: dreamcinezone_files)

# If MULTIPLE_DB Is True Then Fill DATABASE_URI2 Value Else You Will Get Error.
MULTIPLE_DB = is_enabled(os.environ.get('MULTIPLE_DB', "True"), True) # Type True For Turn On MULTIPLE DB FUNTION 
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://shebinkallankunnan_db_user:kGcXRIsMv00mHieF@forwardcluster.lwso62u.mongodb.net/myDatabase?retryWrites=true&w=majority")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
# Movie Notification & Update Settings
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', False))  # Notification On (True) / Off (False)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003700411154'))  # Notification of sent to your channel
...
DELETE_TIME = int(environ.get("DELETE_TIME", "500"))  #  deletion time in seconds (default: 5 minutes). Adjust as per your needs.
