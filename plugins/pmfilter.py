        ...
        if pm_search:
            ...
            await message.reply_text(
                text=(
                    ...
                    "<blockquote>"
                    "𝒀𝒐𝒖 𝒄𝒂𝒏 𝒔𝒆𝒂𝒓𝒄𝒉 𝒇𝒐𝒓 𝒎𝒐𝒗𝒊𝒆𝒔 𝒐𝒏𝒍𝒚 𝒊𝒏 𝒐𝒖𝒓 𝑴𝒐𝒗𝒊𝒆 𝑮𝒓𝒐𝒖𝒑."
                    "𝒀𝒐𝒖 𝒂𝒓𝒆 𝒏𝒐𝒕 𝒂𝒍𝒍𝒐𝒘𝒆𝒅 𝒕𝒐 𝒔𝒆𝒂𝒓𝒄𝒉 𝒇𝒐𝒓 𝑴𝒐𝒗𝒊𝒆𝒔 𝒐𝒏 𝑻𝒉𝒊𝒔 𝑫𝒊𝒓𝒆𝒄𝒕 𝑩𝒐𝒕. 𝑷𝒍𝒆𝒂𝒔𝒆 𝒄𝒍𝒊𝒄𝒌 𝒐𝒏 𝒕𝒉𝒆 𝑹𝑬𝑸𝑼𝑬𝑺𝑻 𝑯𝑬𝑹𝑬 𝑩𝒖𝒕𝒕𝒐𝒏 𝒃𝒆𝒍𝒐𝒘 𝒕𝒐 𝒋𝒐𝒊𝒏 𝒐𝒖𝒓 𝑴𝒐𝒗𝒊𝒆 𝑮𝒓𝒐𝒖𝒑 𝒂𝒏𝒅 𝒔𝒆𝒂𝒓𝒄𝒉 𝒇𝒐𝒓 𝒚𝒐𝒖𝒓 𝒇𝒂𝒗𝒐𝒖𝒓𝒊𝒕𝒆 𝑴𝒐𝒗𝒊𝒆𝒔 𝒕𝒉𝒆𝒓𝒆."
                    "</blockquote></b>"
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('ᴡᴀᴢᴇᴇᴍ 📜', url='https://nokkiirunnoippokittum.com'),
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
